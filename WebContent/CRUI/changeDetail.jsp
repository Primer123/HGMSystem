...
<%@page import="entity.ReservationRecord"%>
...
<html lang="en">
    ...
    <body>
	 ...
	 %>	
		 	 	<tr>
	 			<td width="150"><%=room.getId() %></td>
				<td width="150"><%=room.getTypeid() %></td>
				<td width="60"><%=room.getFloorname() %></td>
				<td width="260"><%=room.getRemarks() %></td>
