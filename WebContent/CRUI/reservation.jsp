                        ...
                        <div class="two-third column last">
                            <form id="reservation-form" class="validate" action="guestinfor">
                                ...
                                <p>
                                 ...
                                 <p>
                                    <label for="idnum" class="required label">证件号码:</label>
                                    <input id="idnum" class="validate[required]" type="text" name="idnum" />
                                </p>
                                <p>
                                    <label for="country" class="required label">国家地区:</label>
                                ...
                                <p>
                                    <label for="telnum" class="required label">电话号码:</label>
                                ...
                                <p>
                                    <label for="smoke" class="label">抽烟喜好:</label>
                                    <select id="smoke" class="validate[required]" name="smoke">
                                        <option value="No Smoke">无烟房</option>
                                        <option value="Smoke">无特别爱好</option>
                                    </select>
                                </p>
                                <p>
                             <label></label>
                                 <input type="radio" name="facility" value="1">有WIFI
                                </p>
                                </br>
                            <p>
                            <a href="search.jsp">
                            <input type="submit" id="submit" class="medium gray button" value="选择房间" />
                                </p>
                            </form>
